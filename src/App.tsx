        ...
        <div className="container">
          ...
          <div className="stategyMain">
            ...
            <div className="stategy_solution">
              <div className="solution one">
                ...
                <div className="solutionImg one">
                  <img src={imgTwo} alt="" className="img__itemOne" />
                </div>
                <ul className="solution__infor">
                  <li className="solution_infor styles">
                    More speed. Less spend
                ...
                <div className="solutionImg one">
                  <img src={imgthree} alt="" className="img__itemOne" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="userContactArea">
            ...
            <div className="userContact">
              <div className="userContact__left">
                <h3>Stay in the loop</h3>
                <p>Join our newsletter to get top news before anyone else.</p>
              </div>
              <div className="userContact__right">
                <input type="text" placeholder="Your best email..." />
                <button className="subscibeBtn">Subscibe</button>
              </div>
            </div>
          </div>
        </div>
