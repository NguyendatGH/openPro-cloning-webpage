  ...
  return (
    <>
        ...
        <div className="">
          <div className="section ProductLst">
            ...
            <span className="item product">
              <a className="line">Web Studio</a>
            </span>
            <span className="item product">
              <a className="line">DynamicBox Flex</a>
            </span>
            <span className="item product">
              <a className="line">Programming Forms</a>
            </span>
          </div>
        </div>
        <div className="">
          <div className="section Resouces">
            <p className=" resouces">Resouces</p>
            <span className="item resouces">
              <a className="line">Nostrud exercitation</a>
            </span>
            <span className="item resouces">
              <a className="line">Visual mockups</a>
            </span>
            <span className="item resouces">
              <a className="line">Nostrud exercitation</a>
            </span>
        ...
        <div className="">
          <div className="section company">
            ...
            <span className="item company">
              <a className="line">Consectetur adipiscing</a>
            </span>
            <span className="item company">
              <a className="line">Labore et dolore</a>
            </span>
            <span className="item company">
              <a className="line">Consectetur adipiscing</a>
            </span>
      ...
      <div className="footer">
        <div className="authorith">
          {" "}
          <p>© Cruip.com. All rights reserved.</p>
        </div>
        <ul className="socialMedia_contactList">
          <li className="icon">
            <svg
